...
<script RunAt="server">
    ...
    public static void RegisterRoutes(RouteCollection routes) {
        ...
        DefaultModel.RegisterContext(typeof( TesterDataClassesDataContext), new ContextConfiguration() { ScaffoldAllTables = true });
    ...
    void Application_Start(object sender, EventArgs e) {
        ...
        Sheduler sch = new Sheduler(43200000);  // 12 hours
